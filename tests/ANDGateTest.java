...
public class ANDGateTest 
{
    ...
    public void testBothTrue() {
        ...
        instance.setInput0(input0);
        instance.setInput1(input1);
        assertEquals("true AND true should generate true", true, output.getValue());
    }
    ...
    public void testTrueAndFalse() {
        ...
        instance.setInput0(input0);
        instance.setInput1(input1);
        assertEquals("true AND false should generate false", false, output.getValue());
    }
    ...
    public void testFalseAndTrue() {
        ...
        instance.setInput0(input0);
        instance.setInput1(input1);
        assertEquals("false AND true should generate false", false, output.getValue());
    }
    ...
    public void testBothFalse() {
        ...
        instance.setInput0(input0);
        instance.setInput1(input1);
        assertEquals("false AND false should generate false", false, output.getValue());
    }     
    ...
    public void testInput0ValueChanged() {
        ...
        input0.setValue(false);
        assertEquals("if the value of input0 changes then the output of the AND gate needs to be recomputed", false, output.getValue());        
    }    
    ...
    public void testInput0Changed() {
        ...
        assertEquals("if input0 is connected to a different output terminal then the output of the AND gate needs to be recomputed", false, output.getValue());        
    }   
    ...
    public void testInput0Cleared() {
        ...
        assertEquals("if input0 is disconnected then the output of the AND gate needs to be recomputed", false, output.getValue());        
    }     
    ...
    public void testInput1ValueChanged() {
        ...
        input1.setValue(false);
	assertEquals("if the value of input1 changes then the output of the AND gate needs to be recomputed", false, output.getValue());
    }    
    ...
    public void testInput1Cleared() {
        ...
        assertEquals("if input1 is disconnected then the output of the AND gate needs to be recomputed", false, output.getValue());        
    }     
}